        ...
        <form action="" method="post">
            <div class="form-row">
                <div class="form-group col-12">
                    ...
                    <input name="name" type="text" class="form-control" id="name" placeholder="Provider name" required>
                </div>
                <div class="form-group col-12">
            ...
            <div class="form-group">
                ...
                <input name="zip_code" type="number" class="form-control" id="zipcode" placeholder="Zip Code" required>
            </div>
            <div class="row">
            ...
            <div class="form-group">
                ...
                <input name="phonenumber" type="number" class="form-control" id="phonenumber" placeholder="Phone Number" required>
            </div>
